...
const Strings = new LocalizedStrings({
  per: {
    ...
    skill: ' توضیحات مهارت',
    seePresentationSkill: 'مهارت ارایه مطالب',
    ...
    back: 'بازگشت',
    personalProfileMessage: 'در این قسمت می‌توانید پرونده‌ی شخصی خود را مشاهده و تکمیل نمایید. لازم به ذکر است که برخی از امکانات سامانه تنها بعد از تکمیل پرونده‌ی کاربری‌تان قابل دسترسی خواهد بود.',
    ...
    welcomeMessage: 'به سامانه‌ی راهنما خوش آمدید! این سامانه خدمات زیادی را برای راهنمایی دانشجویان در دوران تحصیلی ارائه می‌کند.\n در زیر خدمات این سامانه به همراه توضیحی درباره‌ی آنان را مشاهده می‌کنید. برای رفتن به هر بخش، کافیست برروی آن کلیک کنید.',
    ...
    skillPresentInfo: 'ارایه مطالب یکی از مهارت های مهم هر فرد میباشد. زیرا ما علاوه بر آن که نیاز مند کسب اطلاعات هستیم میباست اطلاعات و دستاورد های خود را به دیگران نیز ارایه دهیم.',
