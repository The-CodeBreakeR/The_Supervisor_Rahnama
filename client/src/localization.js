...
const Strings = new LocalizedStrings({
  per: {
    ...
    hardDayInfo: 'روز هایی هستند که شما در آن رخداد های درسی سخت تر و بیشتری نسبت به بقیه دارید و می توانید زودتر آن ها را این جا ببینید تا با برنامه ریزی مناسب خود را برای آن ها آماده کنید.',
